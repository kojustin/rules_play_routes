...
def _play_app_repository_rule_implementation(repository_ctx):
    """Implementation for jko_test_rule"""
    print("writing the file version=%s" % repository_ctx.attr.version)
    print("writing the file url=%s" % repository_ctx.attr.artifact_url)
    repository_ctx.file("hello", content='hi')
    print("downloading the file")
    repository_ctx.download(
        "https://github.com/kojustin/rules_play_routes/archive/0.0.2.tar.gz",
        output="dlpath")
